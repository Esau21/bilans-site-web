<main class="main" id="top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="index.html">
                <img src="{{ asset('assets/img/Bilanss.png') }}" class="img-fluid" width="100px;" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
                    ...
                    <li class="nav-item" data-anchor="data-anchor"><a class="nav-link fw-medium"
                            href="#features">Cararteristicas</a></li>
                    <li class="nav-item" data-anchor="data-anchor"><a class="nav-link fw-medium"
                            href="#pricing">Precios</a></li>
                    <li class="nav-item" data-anchor="data-anchor"><a class="nav-link fw-medium"
                            href="#testimonial">Testimonios</a></li>
                    <li class="nav-item" data-anchor="data-anchor"><a class="nav-link fw-medium" href="#faq">FAQ</a>
                    </li>
                </ul>
                <form class="ps-lg-5">
            ...
            <div class="row align-items-center py-8">
                ...
                <div class="col-md-7 col-lg-6 text-center text-md-start">
                    <span
                        ...
                        El ERP preferido #1
                        <img class="img-fluid float-start me-3" src="assets/img/illustrations/arrow-right.png"
                            alt="" />
                    </span>
                    <h1 class="mb-4 display-3 fw-bold lh-sm">Bilans, el ERP que impulsa tu negocio.
                        <br class="d-block d-lg-none d-xl-block" />
                    </h1>
                    <p class="mt-3 mb-4 fs-1">Gestiona todas las áreas de tu empresa de manera eficiente y en un
                        solo lugar.
                        Con Bilans, automatiza procesos de facturación electrónica, contabilidad, inventarios y más.
                        <br class="d-none d-lg-block" />
                    </p>
                    <a class="btn btn-lg btn-primary rounded-pill hover-top" href="#" role="button">Solicita tu
                        cotización</a>
                    <a class="btn btn-link ps-md-4" href="#" role="button">Contactanos</a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center justify-content-lg-around">
                <div class="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center"><img
                        src="assets/img/gallery/cimco.png" class="img-fluid" width="100px;" alt="" /></div>
                <div class="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center"><img
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center text-md-start">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="py-4"><img class="img-fluid" src="assets/img/illustrations/app.png"
                                            width="90" alt="" /></div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="py-4"><img class="img-fluid" src="assets/img/illustrations/ux.png"
                                            width="90" alt="" /></div>
